...
public class A_UncheckedException {
	 ...
	 *  - ClassCastException
	 *  - ArithmeticException: 0으로 나누면 뜸
	 *  - NegativeArraySizeException
	 *  
	 *  공통점: RuntimeException 계열들의 예외는 충분히 예측 가능한 에러들이므로, 예외자체가 발생하지 않게끔 조건문으로 처리하는게 가장 좋다.
	...
	/*
	 * RuntimeException 계열의 예외는 대부분 조건문으로 해결이 가능
