...
public class OuterClass2 {
	...
	private static String staticStr = "외부정적필드";
	
	// 정적 내부 클래스
	/* - 외부클래스가 로드되는 시점에서 정적 내부클래스도 함께 static 영역으로 저장공간을 할당받는다.
	 * - 외부클래스와 종속적이지 않다.
	 * - 하나의 클래스 파일에 다양한 클래스를 설계할 때 사용. (DTO: Data Transfer Object)
	...
	public static class staticInnerClass { // OuterClass2.staticInnerClass
		...
		public void test() {
//			System.out.println(str); // 스태틱이라 안됨
