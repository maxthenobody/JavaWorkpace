...
public interface Basic {
	 ...
	 *     강제하고자 할 때 사용하기 때문에 "상속"이 주 목적이고, "강제기능구현"은 부가적인 목적이다.
	 *     
	 ...
	 *  - 클래스와 인터페이스의 상속 관계: 클래스 implements 인터페이스, 인터페이스, 인터페이스
	 *  - 인터페이스와 인터페이스의 상속 관계: 인터페이스 extends 인터페이스, 인터페이스, 인터페이스
	 * 
	 */
