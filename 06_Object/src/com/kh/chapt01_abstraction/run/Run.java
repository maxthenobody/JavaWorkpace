package com.kh.chapt01_abstraction.run;

import com.kh.chapt01_abstraction.model.vo.Student;
...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 5. 추상화 & 캡슐화 과정이 필요
		 *  - 내가 구현하고자 하는 프로그램의 목적에 맞는 객체를 선정 후, 그 객체들이 가지고 있을 핵심적인 역할의 속성과 기능만 남기는 행위.
		 * 
		 */
		// 추상화
