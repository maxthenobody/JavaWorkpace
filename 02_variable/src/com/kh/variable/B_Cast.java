...
public class B_Cast {
	 ...
	 *    자료형 변수명 = 값;
	 *    서로 다른 자료형끼리 연산을 수행하고자 한다면, 한 쪽을 형변환 해야함.
	 *    
	 * 형변환의 종류
	...
	public void autoCasting() {
		...
		// 4 byte -> 8 byte
		int i1 = 10;
		// 원래는 이렇게 해야함: double d1 = (double)i1;
		double d1 = i1; // 자동형변환 완료
		...
		int num = '한'; // 한글과 같은 기타나라의 언어는 유니코드표 (0-65xxx)
		
		System.out.println("성 : " + num);
		
		// 특이케이스 5. byte와 short 연산
		byte b1 = 127;
		byte b2 = 127;
		
		// byte나 short로 연산시 연산결과는 항상 int 자료형으로 취급된다. (너무 작아서)
		byte b3 = (byte)(b1 + b2); // 강제형변환 (int -> byte)
	}
	...
	public void forceCasting() {
		...
		// 1. double -> int
		double d1 = 10.89;
		int i1 = (int)d1; // 10.89 -> 10 (버림)
		
		System.out.println("i1 : " + i1);
		
		// 2. double(실수 대표자료형) -> float
		// float f1 = 4.0; // 안됨
		float f2 = 4.0f; // 됨
		float f3 = (float) d1;
		...
		// int iSum = iNum + dNum; // 타입 미스매치
		int iSum1 = iNum + (int)dNum;
