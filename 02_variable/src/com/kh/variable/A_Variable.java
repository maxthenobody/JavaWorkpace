...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("한종윤 : " + 8500 * 6 * 5 + "원");
		System.out.println("한종윤2 : " + 8500 * 6 * 5 + "원");
		System.out.println("한종윤3 : " + 8500 * 6 * 5 + "원");
		System.out.println("한종윤4 : " + 8500 * 6 * 5 + "원");
		System.out.println("한종윤5 : " + 8500 * 6 * 5 + "원");
		...
		System.out.println(name + " : " + pay * time * day + "원");
	...
	public void declareVariable() {
		 ...
		 *  자료형 변수명;
		 *  
		 *  자료형: 어떤 값을 담아낼지, 어떤 크기의 값을 담아낼지에 따라 다르게 지정해야 하는 부분.
		 *  
		 *  변수명: 변수의 이름을 지정하는 부분. 
		 *  
		 *  변수명 명명규칙
		 ...
		 *  3. 해당 영역 안에서 선언한 번수는 해당 영역에서만 사용 가능하다.
		 */
		...
		sNum = 2;
		iNum = 4;
		lNum = 8L; // L 추가시 정수값을 Long으로 해석
		
		// 실수형
		fNum = 4.0f; // 실수형 리터럴 float에 저장시 반드시 f를 붙여줘야함.
		dNum = 8.0;
