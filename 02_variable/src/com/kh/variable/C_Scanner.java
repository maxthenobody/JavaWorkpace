...
public class C_Scanner {
	...
	public void inputTest1() {
		...
		// 한[스페이스]종윤[엔터]
		String firstName = sc.next(); // 한
		String lastName = sc.nextLine(); // [스페이스]종윤
		// nextLine함수는 호출 후 "버퍼"의 값을 비워준다. => [엔터]값 소멸 ******* 중요 ************
		// String secondName = sc.nextLine();
		
		System.out.print("당신의 나이는 몇 살입니까 : ");
		int age = sc.nextInt(); // 입력버퍼에 있는 다음값을 int 차료형으로 뽑아쓰겠다.
	...
	public void inputTest2() {
		...
		char gender = sc.nextLine().charAt(0); // char 강제형변환 안됨. 강제형변환은 기본자료형만 가능함. 문자는 참조자료형임.
		// 0 -> 0번째 문자.
		// "male" -> "m"
		// "0123"
		 ...
		 *    sc.nextLine()을 통해 "문자열"을 입력받고, 그 후 charAt(인덱스)를 호출한다.
		 */
	}
