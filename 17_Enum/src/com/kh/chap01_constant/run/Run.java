...
import com.kh.chap01_constant.model.vo.*;
...
public class Run {	
	public static void main(String[] args) {
		...
		// Java 에서는 boolean 으로 관리하는 값을, Oracle 과 같은 서버에서는 "true"라는 문자열로 관리될 때,
		// true, "true"는 한 묶음으로 관리되어야 한다.
		...
		car2.setColor(Color.BLACK); // 검증기능 O
	}
}
