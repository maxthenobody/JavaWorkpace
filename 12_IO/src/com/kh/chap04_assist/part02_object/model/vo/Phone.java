 ...
 *    객체를 byte 로 변환하여 저장하는 방식 => 직렬화
 *    byte 로 저장된 데이터를 객체로 다시 변환하는 방식 => 역직렬화
 *    
 *  - 직렬화를 구현하기 위해서는 클래스에 Serializable 인터페이스를 상속시켜줘야한다.
...
public class Phone implements Serializable {
	...
	private String name;
	private int price;
	private transient String number; // 보안상 중요한 데이터로 가정.
